          ...
          <div className="flex flex-col items-center">
            ...
            <div className="paragraphs flex max-w-[830px] flex-col items-start gap-8 lg:flex-row lg:gap-4">
              <div className="flex flex-col  gap-4 text-left lg:gap-8 lg:text-center lg:text-lg">
                <p>
                  We believe that coding is an essential skill for the future,
                  and we are committed to making it accessible and fun for
                  children of all ages.
                </p>
                <p>
                  Our academy offers a wide range of programming courses
                  designed specifically for kids, taught by experienced
                  instructors who are passionate about coding and teaching.
                </p>
              </div>
            </div>
